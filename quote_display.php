...
<li  id="linkz" class="last"><a href="http://www.fethullah-gulen.org/wp-content/uploads/2013/11/happiness.jpg">purpose</a></li>
</ul>
    ...
    <li id="linkz" class="main  ml">
        ...
        <div id="dialog-form" title="Create new user">
          ...
          <fieldset>
            ...
            <label for="password">Password</label>
            <input type="password" name="password" id="password" value="" class="text ui-widget-content ui-corner-all">
            <label for="password">Quote</label>
...
<script>
       ...
       <div id="tfheader">    
        ...
        <a id="quote"> <?php echo $quote; ?><p id="quotestyle"></p>
           <form id="tfnewsearch" method="post" action="guess_topic.php">
                ...
                <input type="submit" value="Get another quote" class="tfbutton">
           </form>
